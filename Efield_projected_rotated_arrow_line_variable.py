# -*- coding: utf-8 -*-
"""
Created on Sun Mar 15 22:19:01 2020
...
for i in range(len(x)):
    ...
    if(vcrossB_rotated[i]>0):
        
        EvcrossB_charge_excess[i]= -np.sqrt(E_charge_excess**2 - Evcross_vcrossB_rotated[i]**2) # Conditions pour que le charge excess pointe vers le centre
        Evcross_vcrossB_charge_excess[i] = Evcross_vcrossB_rotated[i]
...
plt.savefig('./images_Efield_projected_rotated/Efield_projected_rotated_arrow_line_variable.png', dpi = 2000)
plt.show()
